...
const debugObject = {};
debugObject.depthColor = '#054d85';
debugObject.surfaceColor = '#9ec3ff';
...
gui.addColor(debugObject, 'depthColor').onChange(function() { waterMaterial.uniforms.uDepthColor.value.set(debugObject.depthColor) });
gui.addColor(debugObject, 'surfaceColor').onChange(function() { waterMaterial.uniforms.uSurfaceColor.value.set(debugObject.surfaceColor) });
